...
val JS_IR_BACKEND_TEST_WHITELIST = listOf(
    ...
    "js/js.translator/testData/box/extensionProperty/propertyWithGetterAndSetter.kt",
    "js/js.translator/testData/box/extensionProperty/privateExtensionProperty.kt",
    "js/js.translator/testData/box/closure/recursiveFunction.kt",
    "js/js.translator/testData/box/closure/closureThisInExtLambdaInsideMethod.kt",
    "js/js.translator/testData/box/closure/closureThisInLambdaInsideMethod.kt",
    "js/js.translator/testData/box/closure/recursiveFunctionWithSameNameDeclaration.kt",
    "js/js.translator/testData/box/closure/enclosingClassFromLocalClass.kt",
    "js/js.translator/testData/box/closure/closureFunctionAsArgument.kt",
    "js/js.translator/testData/box/closure/closureLocalInNestedObject.kt",
    "js/js.translator/testData/box/closure/closureInWithInsideWith.kt",
    "js/js.translator/testData/box/closure/closureInNestedFunctions.kt",
    "js/js.translator/testData/box/closure/closureInNestedFunctionsWhichMixedWithObject.kt",
    "js/js.translator/testData/box/callableReference/function/extensionFromTopLevelUnitNoArgs.kt",
    "js/js.translator/testData/box/callableReference/function/extensionFromTopLevelStringOneStringArg.kt",
    "js/js.translator/testData/box/callableReference/function/extensionWithClosure.kt",
    "js/js.translator/testData/box/callableReference/function/extensionFromExtension.kt",
    "js/js.translator/testData/box/callableReference/function/topLevelFromTopLevelStringNoArgs.kt",
    "js/js.translator/testData/box/callableReference/function/extensionFromTopLevelUnitOneStringArg.kt",
    "js/js.translator/testData/box/callableReference/function/extensionFromClass.kt",
    "js/js.translator/testData/box/callableReference/function/extension.kt",
    "js/js.translator/testData/box/callableReference/function/localLocal.kt",
    "js/js.translator/testData/box/callableReference/function/simpleClosure.kt",
    "js/js.translator/testData/box/callableReference/function/extensionFromTopLevelStringNoArgs.kt",
    "js/js.translator/testData/box/callableReference/function/simpleWithArg.kt",
    "js/js.translator/testData/box/callableReference/function/closureWithSideEffect.kt",
    "js/js.translator/testData/box/callableReference/function/simple.kt",
    "js/js.translator/testData/box/extensionFunction/virtualExtension.kt",
    "js/js.translator/testData/box/extensionFunction/extensionUsedInsideClass.kt",
    "js/js.translator/testData/box/extensionFunction/extensionPropertyOnClassWithExplicitAndImplicitReceiver.kt",
    ...
    "js/js.translator/testData/box/extensionFunction/extensionFunctionOnExpression.kt",
    "js/js.translator/testData/box/extensionFunction/extensionWithImplicitReceiver.kt",
    "js/js.translator/testData/box/extensionFunction/extensionForSuperclass.kt",
    "js/js.translator/testData/box/extensionFunction/superClassMemberInExtension.kt",
    "js/js.translator/testData/box/extensionFunction/intExtension.kt",
    ...
    "js/js.translator/testData/box/inlineEvaluationOrder/alsoWithReassingment.kt",
    "js/js.translator/testData/box/inline/innerOuterThis.kt",
    "js/js.translator/testData/box/inline/severalUsage.kt",
    "js/js.translator/testData/box/inline/rootConstructor.kt",
    "js/js.translator/testData/box/inline/simpleLambda.kt",
    ...
    "js/js.translator/testData/box/examples/closureWithParameter.kt",
    "js/js.translator/testData/box/examples/propertyDelegation.kt",
    "js/js.translator/testData/box/examples/doubleEnclosedLocalVariable.kt",
    "js/js.translator/testData/box/examples/inheritedMethod.kt",
    "js/js.translator/testData/box/examples/kt242.kt",
    "js/js.translator/testData/box/examples/simplestClosureAndBoxing.kt",
    "js/js.translator/testData/box/examples/funDelegation.kt",
    "js/js.translator/testData/box/examples/inheritedInnerClass.kt",
    "js/js.translator/testData/box/examples/enclosingLocalVariable.kt",
    ...
    "js/js.translator/testData/box/examples/simplestClosure.kt",
    ...
    "js/js.translator/testData/box/inlineSizeReduction/noDuplicateVariableDeclaration.kt",
    "js/js.translator/testData/box/inlineSizeReduction/inlineLambdaCleanup.kt",
    ...
    "js/js.translator/testData/box/expression/misc/funInConstructorBlock.kt",
    ...
    "js/js.translator/testData/box/expression/misc/packagePropertyCalledAsFun.kt",
    "js/js.translator/testData/box/expression/misc/funInConstructor.kt",
    "js/js.translator/testData/box/expression/misc/propertiesWithExplicitlyDefinedAccessorsWithoutBodies.kt",
    "js/js.translator/testData/box/expression/misc/KT-1361-1.kt",
    "js/js.translator/testData/box/expression/misc/propertyAsFunCalledOnConstructor.kt",
    ...
    "js/js.translator/testData/box/objectDeclaration/objectWithMethods.kt",
    "js/js.translator/testData/box/objectDeclaration/kt3684.kt",
    "js/js.translator/testData/box/objectDeclaration/objectInMethod.kt",
    ...
    "js/js.translator/testData/box/nestedTypes/nested.kt",
    "js/js.translator/testData/box/multideclaration/multiValOrVar.kt",
    "js/js.translator/testData/box/expression/invoke/invokeWithExtensionReceiver.kt",
    ...
    "js/js.translator/testData/box/expression/invoke/invokeInFunctionLiteral.kt",
    "js/js.translator/testData/box/expression/invoke/invokeOnExprByConvention.kt",
    "js/js.translator/testData/box/expression/invoke/invokeWithDispatchAndExtensionReceivers.kt",
